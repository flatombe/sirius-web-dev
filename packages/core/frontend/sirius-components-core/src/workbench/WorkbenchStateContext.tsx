...
export const WorkbenchStateContextProvider = ({
  initialWorkbenchState,
  children,
}: WorkbenchStateContextProviderProps) => {
  const [state, setState] = useState<WorkbenchStateContextProviderState>({
    workbenchState: initialWorkbenchState ?? defaultWorkbenchState,
  });

  const setWorkbenchState = useCallback((workbenchState: WorkbenchState) => {
