...
export const Panels = forwardRef<WorkbenchSidePanelConfigurationsSupplier, PanelsProps>(
  (
    {
      editingContextId,
      readOnly,
    ...
    ref: ForwardedRef<WorkbenchSidePanelConfigurationsSupplier>
  ) => {
    disableGlobalCursorStyles();

    const leftActivePanelConfiguration: WorkbenchViewConfiguration | null =
      leftPanelConfiguration?.views.find((configuration) => configuration.isActive) ?? null;
    ...
    const rightActivePanelConfiguration: WorkbenchViewConfiguration | null =
      rightPanelConfiguration?.views.find((configuration) => configuration.isActive) ?? null;
            ...
            {leftContribution !== null && leftPanelState.isOpen ? (
              <WorkbenchPart
                ...
                initialConfiguration={
                  leftPanelConfiguration?.views.find((configuration) => configuration.id === leftContribution.id) ??
                  null
                }
              />
            ) : null}
          ...
          <Panel
            ...
            {rightContribution !== null && rightPanelState.isOpen ? (
              <WorkbenchPart
                ...
                initialConfiguration={
                  rightPanelConfiguration?.views.find((configuration) => configuration.id === rightContribution.id) ??
                  null
                }
              />
            ) : null}
