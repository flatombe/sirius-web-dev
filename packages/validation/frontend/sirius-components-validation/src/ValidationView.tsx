...
export const ValidationView = forwardRef<ValidationViewConfigurationSupplier, WorkbenchViewComponentProps>(
  (
    { editingContextId }: WorkbenchViewComponentProps,
    _validationViewConfigurationSupplierRef: ForwardedRef<WorkbenchViewConfigurationSupplier>
  ) => {
