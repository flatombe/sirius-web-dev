...
export const EditProjectView = () => {
  ...
  const refWorkbenchConfigurationSupplier = useRef<WorkbenchConfigurationSupplier>(null);
          ...
          <SelectionSynchronizer>
            <RepresentationPathContext.Provider value={{ getRepresentationPath }}>
              <OmniboxProvider editingContextId={state.project.currentEditingContext.id}>
                <UndoRedo>
                  <EditProjectNavbar
                    workbenchConfigurationSupplier={refWorkbenchConfigurationSupplier.current}
                    readOnly={readOnly}
                  />
                  <TreeToolBarProvider>
                    <Workbench
                      ...
                      ref={refWorkbenchConfigurationSupplier}
                    />
                  </TreeToolBarProvider>
                </UndoRedo>
              </OmniboxProvider>
