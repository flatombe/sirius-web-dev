...
export const RelatedElementsView = forwardRef<RelatedElementsViewConfigurationSupplier, WorkbenchViewComponentProps>(
  (
    { editingContextId, readOnly }: WorkbenchViewComponentProps,
    _relatedElementsViewConfigurationSupplierRef: ForwardedRef<WorkbenchViewConfigurationSupplier>
  ) => {
