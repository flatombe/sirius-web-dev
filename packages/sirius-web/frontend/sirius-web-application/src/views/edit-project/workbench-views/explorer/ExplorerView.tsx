...
import { ExplorerViewConfigurationSupplier, ExplorerViewState } from './ExplorerView.types';
...
export const ExplorerView = forwardRef<ExplorerViewConfigurationSupplier, WorkbenchViewComponentProps>(
  (
    { editingContextId, readOnly }: WorkbenchViewComponentProps,
    _explorerViewConfigurationSupplierRef: ForwardedRef<WorkbenchViewConfigurationSupplier>
  ) => {
