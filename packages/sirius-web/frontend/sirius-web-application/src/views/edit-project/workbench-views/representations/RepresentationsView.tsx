...
export const RepresentationsView = forwardRef<RepresentationsViewConfigurationSupplier, WorkbenchViewComponentProps>(
  (
    { editingContextId, readOnly }: WorkbenchViewComponentProps,
    _representationsViewConfigurationSupplierRef: ForwardedRef<WorkbenchViewConfigurationSupplier>
  ) => {
