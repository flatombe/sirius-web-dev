...
import { DetailsViewConfigurationSupplier, DetailsViewState } from './DetailsView.types';
...
export const DetailsView = forwardRef<DetailsViewConfigurationSupplier, WorkbenchViewComponentProps>(
  (
    { editingContextId, readOnly }: WorkbenchViewComponentProps,
    _detailsViewConfigurationSupplierRef: ForwardedRef<WorkbenchViewConfigurationSupplier>
  ) => {
