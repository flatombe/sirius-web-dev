...
const workbenchViewContributions: WorkbenchViewContribution[] = [
  {
    ...
    ref: undefined,
    createRef: () =>
      useRef<ExplorerViewConfigurationSupplier>({
  ...
  },
  {
    ...
    ref: undefined,
    createRef: () =>
      useRef<ValidationViewConfigurationSupplier>({
        getWorkbenchViewConfiguration() {
          return null;
        },
      }),
  },
  {
    ...
    ref: undefined,
    createRef: () =>
      useRef<DetailsViewConfigurationSupplier>({
        getWorkbenchViewConfiguration() {
          return null;
        },
      }),
  },
  {
    ...
    ref: undefined,
    createRef: () =>
      useRef<QueryViewConfigurationSupplier>({
        getWorkbenchViewConfiguration() {
          return null;
        },
      }),
  },
  {
    ...
    ref: undefined,
    createRef: () =>
      useRef<RepresentationsViewConfigurationSupplier>({
        getWorkbenchViewConfiguration() {
          return null;
        },
      }),
  },
  {
    ...
    ref: undefined,
    createRef: () =>
      useRef<RelatedElementsViewConfigurationSupplier>({
        getWorkbenchViewConfiguration() {
          return null;
        },
      }),
